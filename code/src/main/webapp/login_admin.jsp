...
<body style="background-image: url(assets/images/login_bg.jpg);background-size:100%" class="layui-anim layui-anim-scaleSpring">
		...
		<div id="main-body" align="left" style="margin-top: 200px">
			<div align="center" style="width: 100%; margin-top: 30px;">
				...
				<div style="width: 300px;" class="layui-anim layui-anim-up">
					<h2 style="margin-bottom: 30px;color: white;font-size:  24px;">网课资源共享与发布管理系统</h2>
